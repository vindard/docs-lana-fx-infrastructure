...
**Why this term:** An exchange rate is a dimensionless ratio between two currencies. A currency translation is the recorded outcome of using that ratio on a concrete amount. Naming both "rates" obscures this distinction — the rate is an input, the translation is the result. IAS 21 uses "foreign currency translation" as its formal term for this operation — converting foreign-currency amounts into the functional currency at a given rate for ledger recording purposes.
